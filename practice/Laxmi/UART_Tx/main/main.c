...
#define TXD_PIN 17         // Connect to RX of device
#define RXD_PIN 16         // Connect to TX of device
#define BUF_SIZE (1024)					//Define Buffer size in byte

static const char *TAG = "UART_EX";

// Task to read data from UART
/* This is a FreeRTOS task.Runs in parallel with other tasks.Responsible only for receiving data from UART.*/
